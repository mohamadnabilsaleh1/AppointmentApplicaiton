...
{
    public class GetDoctorByUserIdQueryHandler : IRequestHandler<GetDoctorByUserIdQuery, Result<DoctorWithContactDto>>
    {
        ...
        public async Task<Result<DoctorWithContactDto>> Handle(GetDoctorByUserIdQuery request, CancellationToken cancellationToken)
        {

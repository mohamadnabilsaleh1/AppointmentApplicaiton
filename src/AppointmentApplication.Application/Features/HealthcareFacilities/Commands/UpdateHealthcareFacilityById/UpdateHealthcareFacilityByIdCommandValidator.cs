...
public sealed class UpdateHealthcareFacilityByIdCommandValidator : AbstractValidator<UpdateHealthcareFacilityByIdCommand>
{
    public UpdateHealthcareFacilityByIdCommandValidator()
    {
        RuleFor(x => x.Name)

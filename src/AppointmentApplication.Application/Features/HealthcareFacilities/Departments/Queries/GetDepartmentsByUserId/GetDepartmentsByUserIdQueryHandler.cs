...
{
    public class GetDepartmentsByUserIdQueryHandler : IRequestHandler<GetDepartmentsByUserIdQuery, Result<List<DepartmentDto>>>
    {
        private readonly IAppDbContext _context;

        public GetDepartmentsByUserIdQueryHandler(IAppDbContext context)
        {
            _context = context;
        }

        public async Task<Result<List<DepartmentDto>>> Handle(GetDepartmentsByUserIdQuery request, CancellationToken cancellationToken)
        {

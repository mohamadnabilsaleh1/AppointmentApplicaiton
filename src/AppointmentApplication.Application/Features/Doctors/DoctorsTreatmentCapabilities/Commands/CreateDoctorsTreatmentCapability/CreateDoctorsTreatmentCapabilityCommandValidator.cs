...
{
    public class CreateDoctorsTreatmentCapabilityCommandValidator : AbstractValidator<CreateDoctorsTreatmentCapabilityCommand>
    {
        public CreateDoctorsTreatmentCapabilityCommandValidator()
        {
            RuleFor(x => x.UserId)

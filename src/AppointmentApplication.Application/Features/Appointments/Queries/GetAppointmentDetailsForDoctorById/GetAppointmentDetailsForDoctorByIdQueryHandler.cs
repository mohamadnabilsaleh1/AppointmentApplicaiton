...
{
    public class GetAppointmentDetailsForDoctorByIdQueryHandler
        : IRequestHandler<GetAppointmentDetailsForDoctorByIdQuery, Result<AppointmentDetailsDto>>
    {
        private readonly IAppDbContext _context;

        public GetAppointmentDetailsForDoctorByIdQueryHandler(IAppDbContext context)
        {
            _context = context;
        }

        public async Task<Result<AppointmentDetailsDto>> Handle(
            GetAppointmentDetailsForDoctorByIdQuery request,
            CancellationToken cancellationToken)
        {
            ...
            var appointmentQuery = _context.Appointments
                ...
                .Where(a => a.Id == request.AppointmentId && a.DoctorId == doctor.Id);

...
{
    public class CreateAppointmentCommandByDoctorValidator : AbstractValidator<CreateAppointmentByDoctorCommand>
    {
        private readonly IAppDbContext _context;

        public CreateAppointmentCommandByDoctorValidator(IAppDbContext context)
        {
            _context = context;

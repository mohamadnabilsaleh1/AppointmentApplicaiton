...
namespace AppointmentApplication.Application.Features.Appointments.Commands.CompleteAppointment
{
    public class CompleteAppointmentCommandHandler : IRequestHandler<CompleteAppointmentCommand, Result<AppointmentCompletionDto>>
    {
            ...
            CancellationToken cancellationToken)
        {
            try
            {
                _logger.LogInformation("Completing appointment {AppointmentId} for user {UserId}", 
                ...
                {
                    _logger.LogWarning("User {UserId} is not authorized to complete appointment {AppointmentId}", 
                ...
                {
                    _logger.LogWarning("Appointment {AppointmentId} cannot be completed. Current status: {Status}", 
                ...
                {
                    _logger.LogWarning("Cannot complete appointment {AppointmentId} without paid billing", 
                ...
                {
                    _logger.LogWarning("Failed to complete appointment: {Errors}", 
                ...
                {
                    _logger.LogWarning("Failed to create medical record: {Errors}", 
                ...
                {
                    _logger.LogWarning("Failed to create prescription: {Errors}", 
            ...
            {
                _logger.LogError(ex, 
                    "Error completing appointment. AppointmentId: {AppointmentId}, UserId: {UserId}", 
                    request.AppointmentId, request.UserId);
                throw;
            }
        }
